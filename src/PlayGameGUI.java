...
public class PlayGameGUI {
    ...
    public void createPanel(){
        ...
        centerPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 80, 5));
        ...
        seperator5.setFont(new Font("Arial", Font.PLAIN, 17));
        seperator5.setForeground(new Color(200,200,200));
        centerPanel.add(seperator5);

        centerPanel.add(playRoundButton);

        JLabel seperator6 = new JLabel(seperatorText);
        seperator6.setFont(new Font("Arial", Font.PLAIN, 17));
        ...
        if(game.getNumOfPlayers() == 1){
            ...
            if(!(game.getRoundCount() == 0)){
                ...
                playerOneScore.setFont(new Font("Arial", Font.PLAIN, 13));
            ...
            if(!(game.getRoundCount() == 0)){
                ...
                bottomPanel.setLayout(new FlowLayout(FlowLayout.CENTER,180,10));
                bottomPanel.add(playerOneScore, Component.CENTER_ALIGNMENT);
                centerPanel.add(backButton, Component.CENTER_ALIGNMENT);
    ...
    public void createButtons(){
        ...
        playRoundButton.setPreferredSize(new Dimension(70, 20));
